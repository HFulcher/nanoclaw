...
function ensureContainerSystemRunning(): void {
  // Detect runtime: try Docker first (more common on Linux), then Apple Container
  ...
  try {
    ...
    try {
      execSync('container --version', { stdio: 'pipe', timeout: 3000 });
      runtime = 'container';
  ...
  // Apple Container needs system startup
